...
> against the `1.8.2` build: the 1.1.0 stream feature set, three defect sweeps (thirteen in
...
|---|---|---|---|---|---|
| chrome | `dist/release/aetherdl-1.8.2-chrome.zip` | 142 773 | 20 | `c77ff51caa0b28836ca6146a6eb5beb6f9d24ab0ebc3605604844c0fe2f17ab4` | Chrome Web Store, Microsoft Edge Add-ons, Opera add-ons, other Chromium-compatible stores |
| firefox | `dist/release/aetherdl-1.8.2-firefox.zip` | 142 840 | 20 | `fc02a99177be53ac1d3e5dc54380458d3c510944cd2558d35354cf30f2a13980` | Firefox Add-ons (AMO) |
