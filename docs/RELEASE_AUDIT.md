...
> against the `1.8.3` build: the 1.1.0 stream feature set, three defect sweeps (thirteen in
...
|---|---|---|---|---|---|
| chrome | `dist/release/aetherdl-1.8.3-chrome.zip` | 142 874 | 20 | `37cc2e1388913f07e707bb20c9027e2bc844cc09357ca0d51096d6cbb3ccd94d` | Chrome Web Store, Microsoft Edge Add-ons, Opera add-ons, other Chromium-compatible stores |
| firefox | `dist/release/aetherdl-1.8.3-firefox.zip` | 142 941 | 20 | `96a5d0c7eb6405632ef87dd0f55eacf2bdd739b75dba4e9c60b43de2f54764a4` | Firefox Add-ons (AMO) |
