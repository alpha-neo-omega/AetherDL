...
> against the `1.8.5` build: the 1.1.0 stream feature set, three defect sweeps (thirteen in
...
|---|---|---|---|---|---|
| chrome | `dist/release/aetherdl-1.8.5-chrome.zip` | 143 135 | 20 | `a7edc0a5ed6c3973b05a563c644ad9d4357e252c22b611a4259e1a8469cdd93c` | Chrome Web Store, Microsoft Edge Add-ons, Opera add-ons, other Chromium-compatible stores |
| firefox | `dist/release/aetherdl-1.8.5-firefox.zip` | 143 201 | 20 | `da7902f8fed43457017c65016ae5232ac93eb08d0be3552ee0164158626ce548` | Firefox Add-ons (AMO) |
