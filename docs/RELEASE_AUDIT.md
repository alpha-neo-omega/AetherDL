...
> against the `1.8.4` build: the 1.1.0 stream feature set, three defect sweeps (thirteen in
...
|---|---|---|---|---|---|
| chrome | `dist/release/aetherdl-1.8.4-chrome.zip` | 143 136 | 20 | `292a49e63fd536c0dcd75b7886e3c182b306a95985b2f2bf9911090712cbc558` | Chrome Web Store, Microsoft Edge Add-ons, Opera add-ons, other Chromium-compatible stores |
| firefox | `dist/release/aetherdl-1.8.4-firefox.zip` | 143 203 | 20 | `7c7a4485ccca5c98a8ac2122b0e6b8ec78c691d3a2a474b2420ad3e708cb6e33` | Firefox Add-ons (AMO) |
