...
> against the `1.8.6` build: the 1.1.0 stream feature set, three defect sweeps (thirteen in
...
|---|---|---|---|---|---|
| chrome | `dist/release/aetherdl-1.8.6-chrome.zip` | 143 716 | 20 | `f4e81b1fdc48770c5820b9415900d82fb2fc5776667947b304d595cdb047bde4` | Chrome Web Store, Microsoft Edge Add-ons, Opera add-ons, other Chromium-compatible stores |
| firefox | `dist/release/aetherdl-1.8.6-firefox.zip` | 143 782 | 20 | `abb5129260e311df5d767b602da23c5b9c126cc4b42e2630caea7964f9dd39d9` | Firefox Add-ons (AMO) |
